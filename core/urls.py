...
router.register('analysis_result', viewsets.ResultViewSet) # /api/skin/analysis_result/
router.register('file_image',viewsets.FileImageViewSet) # /api/skin/file_image/
